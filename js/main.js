...
$("#loadMore").on('click', function (e) {
    e.preventDefault();
    $(".section__events-article-card:hidden").slice(0, num).slideDown();
})
...
window.addEventListener('DOMContentLoaded', function () {
    document.querySelector('.burger-menu-btn').addEventListener('click', function () {
        document.querySelector('.section__header-nav-lc-wrap').classList.toggle('open-burger-menu')
    })
})
...
window.addEventListener('DOMContentLoaded', function () {
    document.querySelector('.section__editions-category-btn').addEventListener('click', function (event) {
